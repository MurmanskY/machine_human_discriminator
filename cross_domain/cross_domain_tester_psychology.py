...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output_path", type=str, default="./results/scores_new_psychology.xlsx", help="结果保存的Excel路径（可选）")
    parser.add_argument("--scatter_path", type=str, default="./results/score_scatter_psychology.png", help="散点图保存路径")
    parser.add_argument("--sources", type=str, nargs="+", default=["psychology"], help="筛选的来源域列表，如 law 等。如果不提供则使用全部数据")
    ...
    parser.add_argument("--ckpt_path", type=str, default="../checkpoints/shared_encoder_adapter_jsonl_psychology.pth", help="编码器权重文件路径")
...
# 新增功能 2: 固定阈值下的 F1 分数
given_thr = 1.263969  # 你可以修改为其他想要的硬编码阈值
