...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output_path", type=str, default="./results/scores_new_finance.xlsx", help="结果保存的Excel路径（可选）")
    parser.add_argument("--scatter_path", type=str, default="./results/score_scatter_finance.png", help="散点图保存路径")
    parser.add_argument("--sources", type=str, nargs="+", default=["finance"], help="筛选的来源域列表，如 law 等。如果不提供则使用全部数据")
    ...
    parser.add_argument("--ckpt_path", type=str, default="../checkpoints/shared_encoder_adapter_jsonl_finance.pth", help="编码器权重文件路径")
    ...
    for text in texts:
        ...
        #     print(f"无效输入，跳过：{text}")
        #     continue  # 如果text不是字符串，跳过当前循环，处理下一个文本
...
# 新增功能 2: 固定阈值下的 F1 分数
given_thr = 5.543227  # 你可以修改为其他想要的硬编码阈值
